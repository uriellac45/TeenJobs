...
public class SelectResume extends AppCompatActivity {
    ...
    private void fillAutoCompleteJobs() {
        enterJ = findViewById(R.id.enterJ);
    ...
    public void end(View view) {
        ...
        Employee user = new Employee(
                ...
                (LocalDate) gi.getSerializableExtra("birthday"),
        ...
        varDone.setListener(new VariableListener.ChangeListener() {
            ...
            public void onChange() {
                ...
                if (message == null)
                    startActivity(new Intent(SelectResume.this, MainActivity.class));
                else
                    Toast.makeText(SelectResume.this, message, Toast.LENGTH_SHORT).show();

            }
        });
         fireBaseDB.CreateNewEmployee(user, varDone);
